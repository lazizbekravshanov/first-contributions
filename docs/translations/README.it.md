...
Presto saranno incorporati (*merge*) tutti i tuoi cambiamenti nel main branch di questo progetto. Riceverai una mail di notifica una volta che le modifiche saranno state accettate.
